...
- **App Name**: "Connect More" ✅
- **Icon**: `connect_more_icon.png` (1024x1024) ✅
- **Favicon**: `favicon.png` ✅
...
The `slug` field in `app.json` is set to `bolt-expo-nativewind` to match your existing EAS project. This is just an internal identifier and **does NOT affect** the app name that users see. Your app will still show as **"Connect More"** to users - that's controlled by the `name` field, which is correctly set.
